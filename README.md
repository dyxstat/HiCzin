...
a csv file, containing three columns: contig names, number of restriction sites on contigs, and the length of contigs, or containing two columns: contig names and the length of contigs(e.g. contig_info.csv).
